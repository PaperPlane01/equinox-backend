    ...
    public <X> ValueBinder<X> getBinder(final JavaTypeDescriptor<X> javaTypeDescriptor) {
        return new BasicBinder<X>(javaTypeDescriptor, this) {
            ...
            protected void doBind(PreparedStatement statement, X value, int index,
                ...
                statement.setString(index, javaTypeDescriptor.unwrap(value, String.class, options));
            }

            @Override
            protected void doBind(CallableStatement statement, X value, String name,
                                  WrapperOptions options) throws SQLException {
                statement.setString(name, javaTypeDescriptor.unwrap(value, String.class, options));
            }
        };
    }
}
